...
- (void)viewDidLoad
{
    ...
    self.poemData = [HKCoreDataHandler sharedManager];
}
...
# pragma mark - Abstract Method Handlers
- (void) raiseExceptionForAbstractMethod {
    [NSException raise:@"Invoked abstract method" format:@"You must override this method in a subclass."];
}
